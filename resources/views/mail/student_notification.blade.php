...
<body>
    ...
    <!-- Content Section -->
    <div class="content">
        <h2 style="color: black; font-size: 28px;">Hello {{ $student->full_name }},</h2>
        <i> <p style="font-size: 18px;">This is a notification from OJTIMS regarding your status update. The updated status of your Memorandum of Agreement is:</p></i>
